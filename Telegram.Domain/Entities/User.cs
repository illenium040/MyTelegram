...
public class User : AggregateRoot
{
    ...
    private readonly List<UserChat> _chats;
    [BackingField(nameof(_chats))]
    public IReadOnlyList<UserChat> UserChats => _chats;

    private readonly List<BlockedUser> _blocked;
    [BackingField(nameof(_blocked))]
    public IReadOnlyList<BlockedUser> BlockedUsers => _blocked;
