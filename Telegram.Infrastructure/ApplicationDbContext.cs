...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Folder>(folder => folder.HasKey(x => x.Id));
        ...
        modelBuilder.Entity<OutboxMessage>(msg => msg.HasKey(x => x.Id));
        modelBuilder.Entity<OutboxMessageConsumer>(msg => msg.HasKey(x => x.Id));
